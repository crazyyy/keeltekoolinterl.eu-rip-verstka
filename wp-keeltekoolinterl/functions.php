...
function wpeHeadNav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="menu-keelekesuks" class="menu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function wpeFootNav() {
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="menu-tolkeburoo-rus" class="submenu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function wpeSideNav() {
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="menu-keelekeskus-rus-1" class="submenu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function register_html5_menu() {
    register_nav_menus(array( 
        ...
        'footer-menu' => __('Меню в сайдбар #2', 'wpeasy') 
    ));
}
...
if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
        'name' => __('Блок виджетов подвала', 'wpeasy'),
        'description' => __('Максимум 3 виджета, все в футере', 'wpeasy'),
        'id' => 'widgetarea1',
